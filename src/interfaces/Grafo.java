...
public interface Grafo {
     ...
     * @param origem
     * @param destino
     * @throws Exception Uma exceção é lançada quando não é
     ...
     * @throws Exception Quando não existe origem e/ou destino.
     */
     ...
     * @throws Exception Quando o vértice não existe.
     */
     ...
     * @throws Exception Uma exceção é lançada quando o vértice indicado
     * não existe.
     */
     ...
     * @param destino
     * @param peso
     * @throws Exception Uma exceção é lançada quando o(s) vértice(s)
     ...
     * @throws Exception Se não existe origem e/ou destino.
     */
     ...
     * @throws Exception Se a aresta não existe.
     */
